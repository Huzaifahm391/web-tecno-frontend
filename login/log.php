...
if(isset($_POST)& !empty($_POST)){
    session_start();
    $email =  $database->sanitize($_POST['account']);
    $password=  $_POST['password'];
    $res = $database->read($email); 
    while($r=mysqli_fetch_assoc($res)){
    if($res){
       if($r['pss']==$password ){
       $_SESSION['id']=$r['id'];
       $_SESSION['username']=$r['usr_name'];
       header("Location:../index.php");
       }
        else{
            echo "wrong password";
...
<div class="registr">
  ...
  <label for="tab2"> Phone number</label>
  <div class="line"></div>
  <div class="content-container">
    <div class="content" id="c1">
        <form class="form" onsubmit = "return validation()" method="POST" name="f1">
            <div class="form-input">
            <input class="input-ctrl" type="text" name="account" placeholder="Please enter your Email address" autocomplete="off"> 
            <span class="in-msg" style="display: none;"></span>
        </div> 
            <div class="form-input">
            <input class="input-ctrl" type="password" name="password" placeholder="Password" autocomplete="off" > 
            <span class="in-msg" style="display: none;"></span>
        </div> 
            ...
            <button class="btn-cntrl" type="submit" onclick="myfun()">Login</button></div>
        
            <div class="links">
            <a href="account.php">Create account</a> 
            <a href="password.php">Reset my password?</a>
        </div>
        </form> 
    </div>
    ...
    <div class="content" id="c2">
        ...
        <div class="no-input">
            ...
            <input type="text" name="mobile" autocomplete="off" placeholder="Phone number" class="pnm" >
        </div>
...
<div class="submit"></div> 
            <div class="btn-submit">
            <button class="btn-cntrl" type="button" onclick="myfun()">Login</button></div>
