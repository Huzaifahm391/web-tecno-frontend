...
<div>
 ...
 <li><a href="https://www.tecno-mobile.com/pak/homepage"> <img src="camonimages/tecnoLogo.png" ></li></a>
  ...
  <li>
    ...
    <div class="dropdown-content">
      ...
      <a href="https://www.tecno-mobile.com/pak/phones-list?categoryId=171&seriesId=155" class="horizontal"><img src="photos/camon.png"></a>
      	
      <a href="https://www.tecno-mobile.com/pak/phones-list?categoryId=171&seriesId=156" class="horizontal"><img src="photos/spark.png"></a>
      <a href="https://www.tecno-mobile.com/pak/phones-list?categoryId=171&seriesId=157" class="horizontal"><img src="photos/pop.png"></a>
      <a href="https://www.tecno-mobile.com/pak/phones-list?categoryId=171&seriesId=158" class="horizontal"><img src="photos/pova.png"></a>
  ...
  <li><a class="active" href="https://www.tecno-mobile.com/pak/store">Find Stores</a></li>
...
<div class="container">
 <img src="camonimages/top-pc.jpg" width="1600px" height="200px">
  <div class="centered">Phones</div>
  <div class="centered1">Stop At Nothing</div>
</div>
...
<div class="row">
  <div class="column">
    ...
    <img src="tecnospark/spark8c.png" alt="error" class="tecnoimg">
     <div class="centered2">SPARK 8C</div>
     <a href="spark8cspec.php"><button class="btn1">Learn more</button></a>
  ...
  <div class="column">
    <div class="zoom">
    <div class="container1">
    <img src="tecnospark/spark8pro.png" alt="error" class="tecnoimg">
    <div class="centered2">SPARK 8 Pro</div>
...
<div class="column">
    <div class="zoom">
     <div class="container1">
    <img src="tecnospark/SPARK7T.png" alt="error" class="tecnoimg">
     <div class="centered2">SPARK 7T</div>
     <button class="btn1">Learn more</button>
     <button class="btn2">Buy Now</button>
</div>
    </div>
...
<div class="row">
  ...
  <div class="column">
    <div class="zoom">
     <div class="container1">
    <img src="tecnospark/SPARK7.png" alt="error" class="tecnoimg">
     <div class="centered2">SPARK 7</div>
     <button class="btn1">Learn more</button>
     <button class="btn2">Buy Now</button>
</div>
    </div>
...
<div class="column">
    <div class="zoom">
    <div class="container1">
    <img src="tecnospark/spark6go.png" alt="error" class="tecnoimg">
     <div class="centered2">SPARK 6 Go</div>
     <button class="btn1">Learn more</button>
     <button class="btn2">Buy Now</button>
</div>
    </div>
